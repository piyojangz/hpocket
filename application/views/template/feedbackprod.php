            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row el-element-overlay m-b-40 block1"> 
                        ...
                        <div class="col-md-12">
                            <div class="panel">
                                <div class="panel-heading">รายการ feedback</div>
                                <div class="table-responsive">
                                    ...
                                    <?php foreach ($feedback as $index => $item): ?>  
                                        <table class="table table-hover manage-u-table">
                                            <thead>
                                                <tr>
                                                    <th  style="width:100px" class="text-left">Feedback (<?= $index ?>)</th>  
                                                    <th width="70" class="text-left">Emp</th> 
                                                    <th width="70" class="text-left">Create time</th> 
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php foreach (json_decode($this->firebase->get("LogProd/Feedback/$index")) as $item2): ?> 
                                                    <tr>
                                                        <td style="width:100px" class="text-left"><?= $item2->feedbackdetail->msg ?></td>  
                                                        <td   class="text-left"><?= $item2->feedbackdetail->employeename ?></td>  
                                                        <td   class="text-left"><?= $item2->feedbackdetail->createtime ?></td>  
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
