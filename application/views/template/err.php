                                ...
                                <div class="table-responsive">
                                    ...
                                    <?php foreach ($err as $index => $item): ?>  
                                        <table class="table table-hover manage-u-table">
                                            ...
                                            <tbody>
                                                <?php foreach (json_decode($this->firebase->get("LogDev/Error/$index")) as $index2 => $item2): ?> 
                                                    <tr>
                                                        <td><a target="_blank" href="<?= base_url("log/errdetail/$index/$index2")?>" class="btn   btn-default">view</a></td>
