        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row el-element-overlay m-b-40 block1">
                        <div class="col-md-12">
                            ...
                            <button class="btn-item-modal btn btn-outline btn-primary waves-effect waves-light"><i
                                    class="fa fa-plus m-r-5"></i> <span>เพิ่มหมวด</span></button>
                        ...
                        <div class="col-md-12">
                            <?php if ($hascode == 'true'): ?>
                                <div class="alert alert-danger alert-dismissable">
                                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button> รหัสหมวดหมู่นี้ถูกใช้งานแล้ว. </div>
                            <?php endif; ?>
                            <div class="panel">
                                            ...
                                            <?php foreach ($cate as $index => $item): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button"
                                                                class="btn btn-info btn-outline btn-circle btn-lg m-r-5"
                                                                onclick="removeitem('<?= $item->id ?>', '<?= $token ?>', 'true')"><i
                    ...
                    <form action="<?= base_url("account/$token/addnewcate") ?>" method="post"
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="number" name="code" id="code" required maxlength="2"
                                                                       class="form-control">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
