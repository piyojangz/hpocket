...
<html lang="en">
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">จัดจำหน่ายโดย</h4> </div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                            <ol class="breadcrumb">
                                <li ><a href="#" >จัดจำหน่ายโดย</a></li> 
                    ...
                    <div class="row el-element-overlay m-b-40 block1">
                        <div class="col-md-12">
                            ...
                            <button class="btn-item-modal btn btn-outline btn-primary waves-effect waves-light"> <i class="fa fa-plus-circle m-r-5"></i> <span>เพิ่มรายชื่อบริษัท</span></button>
                                        ...
                                        <tbody>
                                            <?php foreach ($suppliers as $index => $item): ?> 
                                                <tr>
                                                    ...
                                                    <td style="vertical-align: middle;"><?= $item->address1 ?></td> 
                                                    <td style="vertical-align: middle;"><?= $item->address2 ?></td> 
                                                    </td>
                                                    <td> 
                    ...
                    <form action="<?= base_url("account/$token/addnewsupplier") ?>" method="post" class="form-material form-horizontal mfp-hide white-popup-block animate fadeInLeft"  id="form-submit">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-body"> 
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4">ชื่อบริษัท <font style="color: red;">(25 ตัวอักษร) *</font></label>
                                                            <div class="col-md-8">
                                                                <input type="text" name="name" id="name"  maxlength="25" required class="form-control" placeholder="ตัวอย่าง บจก. ดิลก คอร์ปเปอเรชั่น"> 
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4">รายละเอียด1 <font style="color: red;">(40 ตัวอักษร)*</font></label>
                                                            <div class="col-md-8">
                                                                <input type="text" name="detail1" id="detail1"   maxlength="40"  required class="form-control" placeholder="ตัวอย่าง 34/141 ม.8 ซ.บางมดแลนด์10 ถ.ประชาชื่น"> 
                                                            </div>
                                                        </div> 
                                                        <div class="form-group">
                                                            <label class="control-label col-md-4">รายละเอียด2<font style="color: red;">(40 ตัวอักษร)*</font></label>
                                                            <div class="col-md-8">
                                                                <input type="text" name="detail2" id="detail2"   maxlength="40"   required class="form-control" placeholder="ตัวอย่าง ต.บางตลาด อ.ปากเกร็ด จ.นนทบุรี 11120"> 
                                                            </div>
                                                        </div> 
    ...
    <script>
                                                            ...
                                                            function edititem(id) {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: "<?php echo base_url('service/getsupplier'); ?>",
                                                                    data: {'id': id},
                                                                    dataType: "json",
                                                                    success: function (data) {
                                                                        ...
                                                                        if (data.result != null) {
                                                                            ...
                                                                            $("#detail1").val(data.result.address1);
                                                                            $("#detail2").val(data.result.address2);
                                                            ...
                                                            function removeitem(id, token, isdelete) {
                                                                ...
                                                                swal({
                                                                    ...
                                                                    if (isConfirm) {
                                                                        ...
                                                                        location.href = '<?= base_url("account/updatesupplier/") ?>' + id + '/' + token + '/' + isdelete;
