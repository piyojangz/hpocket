    ...
    <body class="fix-header">
                ...
                <div class="container-fluid">
                    <div class="row bg-title">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h4 class="page-title">พิมพ์ สคบ</h4></div>
                        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                            <ol class="breadcrumb">
                                <li><a href="#">พิมพ์</a></li>
                                <li class="active">สคบ</li>
                            </ol>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
        ...
        <!--                                            <th>Photo</th>-->
            ...
            <!--                                                <td><img src="<?= $item->image ?>" alt="iMac" width="80"> </td>-->
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-info btn-outline btn-circle btn-lg m-r-5 printLabel " onclick="openprint('<?= $item->sku ?>', '<?= $item->id ?>')" ><i class="ti-printer"></i></button>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
