                            ...
                            <div class="row">
                                <div class="col-md-9 col-lg-10" style="margin-bottom: 15px;">
                                    ...
                                    <div style="display: block; float: left; ">
                                        ...
                                        <div class="btn-group m-r-10">
                                            <button aria-expanded="false" data-toggle="dropdown"
                                                    ...
                                                    type="button">คำสั่ง <span class="caret"></span></button>
                                    ...
                                    <div style="display: block; float: left; ">
                                        ...
                                        <div class="btn-group m-r-10">
                                            <button id="orderstatus" aria-expanded="false" data-toggle="dropdown"
                                                    class="btn btn-default btn-outline dropdown-toggle waves-effect waves-light"
                                                    type="button">สถานะ <span class="caret"></span></button>
                                            <ul role="menu" class="dropdown-menu">
                                                ...
                                                <li><a href="javascript:;"
                                                       onclick="getorderstatus(4, 'ยกเลิก')">ยกเลิก</a></li>
                                            </ul>
                                ...
                                <div class="col-md-3 col-lg-2">
                                    <form id="export-csv-form" method="POST"
                                          action="<?= base_url("service/exportorderexcel") ?>">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="checkbox checkbox-success checkbox-order ">
                                                    <input id="orderid<?= $item->id ?>" name="orderid" type="checkbox"
                                                           value="<?= $item->id ?>">
                                                    <label for="orderid<?= $item->id ?>"> </label>
                                                </div>
                                            </td>
                                            <td><a class="badge badge-info " target="_blank"
                                                   href="<?= base_url($item->token) ?>"><?= $item->token ?></a></td>
