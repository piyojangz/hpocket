                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="white-box p-l-20 p-r-20">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form class="form-horizontal" method="post" action="<?= base_url("account/$token/updatesetting") ?>" id="form-submit"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input disabled type="text" name="email" class="form-control form-control-line" value="<?= $merchant->email ?>"> </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">เบอร์โทรศัพท์</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="tel" class="form-control form-control-line" value="<?= $merchant->tel ?>"> </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">รายละเอียด</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="detail" class="form-control form-control-line" value="<?= $merchant->description ?>"> </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">LINEID</label>
                                                <div class="col-md-12">
                                                    <input type="text" name="lineid"   class="form-control form-control-line" value="<?= $merchant->lineid ?>"> </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-12">TOKEN</label>
                                                <div class="col-md-12"> 
                                                    <input type="text" disabled  class="form-control form-control-line" value="<?= $token ?>"> </div>
                                            </div>
