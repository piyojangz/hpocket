...
$config['mongo_db']['default']['hostname'] = '18.139.1.10';
$config['mongo_db']['default']['port'] = '2277';
$config['mongo_db']['default']['username'] = 'admin';
$config['mongo_db']['default']['password'] = ';uitp6mT';
$config['mongo_db']['default']['database'] = 'ntl_logs';
